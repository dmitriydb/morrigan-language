...
public class StatementGroupTest extends AbstractInterpreterTest{
  ...
  public void ifStatementGroupTest() {
    morrigan.interpret("morrigan says that if 10 > 5 then "
        + "  morrigan says that a is 1; morrigan says that b is 1."
        + "morrigan says that if 10 < 5 then "
        + "  morrigan says that c is 2; morrigan says that d is 2 "
        + "else"
        + "  morrigan says that c is 3; morrigan says that d is 3.");
  ...
  public void comparisonTest() {
    morrigan.interpret("morrigan says that a is 10, b is 5. morrigan says that if a > b then morrigan remembers what is [a > b]; morrigan remembers what is [more] else   morrigan remembers what is [a < b]; morrigan remembers what is [less].");
  }
  ...
  public void whileWithStatementGroupTest() {
    morrigan.interpret("morrigan says that counter is 0. morrigan says that while counter < 11 morrigan remembers what is [now a is ] + counter; morrigan says that counter is counter + 1."
        );
  }
}
